...
module.exports = {
    ...
    log_level: 'warn',
    api_url: 'http://77.74.64.232:3024',
    ...
    api_services: {
        ...
        mfs: {
            host: 'mfs-test.beeline.kz',
            port: 443,
            ca_ca: './certs/mfs-test.beeline.kz.crt',
            ca_key: './certs/file.key.pem',
            ca_cert: './certs/file.crt.pem',
            passphrase: 'F9HTI3eWKKqjKWKHgsgE6tO4',
            agent: false,
